 ...
 * <p>
 * 印象笔记
 * https://app.yinxiang.com/shard/s23/nl/1787756087/462d0549-b073-40d6-9c00-d52a4bb54279/
 * <p>
 * 参考源码
 * https://github.com/debjava/aopusingjdkdynamicproxy/tree/master/src/main/java/com/ddlab/rnd
 * <p>
 * <p>
 * 本demo作用 利用core java实现aop的简单功能
 * <p>
 * Spring是借助了JDK proxy和CGlib两种技术实现AOP的。 JDK dynamic
 * proxy提供了一种灵活的方式来hook一个方法并执行指定的操作， 但执行操作时得有一个限制条件：必须先提供一个相关的接口以及该接口的实现类。
 */
